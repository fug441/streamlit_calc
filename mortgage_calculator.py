...
st.write("### Repayments")
col1, col2, col3 = st.columns(3) #putting the elements in the same row



#using metric elements that pop more than plain text
...
for i in range(1, number_of_payments +1):
    interest_payment = remaining_balance * monthly_int_rate
